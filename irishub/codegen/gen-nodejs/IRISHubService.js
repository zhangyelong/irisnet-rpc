...
var IRISHubService_GetTotalRewardInfo_args = function(args) {
  this.req = null;
  if (args) {
    if (args.req !== undefined && args.req !== null) {
      this.req = new model_ttypes.TotalRewardInfoRequest(args.req);
    }
  }
};
IRISHubService_GetTotalRewardInfo_args.prototype = {};
IRISHubService_GetTotalRewardInfo_args.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
    ...
    switch (fid)
    {
      case 1:
      if (ftype == Thrift.Type.STRUCT) {
        this.req = new model_ttypes.TotalRewardInfoRequest();
        this.req.read(input);
      } else {
        input.skip(ftype);
      }
...
IRISHubService_GetTotalRewardInfo_args.prototype.write = function(output) {
  output.writeStructBegin('IRISHubService_GetTotalRewardInfo_args');
  if (this.req !== null && this.req !== undefined) {
    output.writeFieldBegin('req', Thrift.Type.STRUCT, 1);
    this.req.write(output);
    output.writeFieldEnd();
...
var IRISHubService_GetTotalRewardInfo_result = function(args) {
  this.success = null;
  this.e = null;
  if (args instanceof model_ttypes.Exception) {
    this.e = args;
  ...
  if (args) {
    if (args.success !== undefined && args.success !== null) {
      this.success = new model_ttypes.TotalRewardInfoResponse(args.success);
    }
    if (args.e !== undefined && args.e !== null) {
      this.e = args.e;
    }
...
IRISHubService_GetTotalRewardInfo_result.prototype = {};
IRISHubService_GetTotalRewardInfo_result.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
    ...
    switch (fid)
    {
      case 0:
      if (ftype == Thrift.Type.STRUCT) {
        this.success = new model_ttypes.TotalRewardInfoResponse();
        this.success.read(input);
      } else {
        input.skip(ftype);
      }
...
IRISHubService_GetTotalRewardInfo_result.prototype.write = function(output) {
  output.writeStructBegin('IRISHubService_GetTotalRewardInfo_result');
  if (this.success !== null && this.success !== undefined) {
    output.writeFieldBegin('success', Thrift.Type.STRUCT, 0);
    this.success.write(output);
    output.writeFieldEnd();
...
IRISHubServiceClient.prototype.GetTotalRewardInfo = function(req, callback) {
  this._seqid = this.new_seqid();
  if (callback === undefined) {
    var _defer = Q.defer();
    this._reqs[this.seqid()] = function(error, result) {
    ...
    this.send_GetTotalRewardInfo(req);
    return _defer.promise;
  } else {
    this._reqs[this.seqid()] = callback;
    this.send_GetTotalRewardInfo(req);
...
IRISHubServiceClient.prototype.send_GetTotalRewardInfo = function(req) {
  var output = new this.pClass(this.output);
  output.writeMessageBegin('GetTotalRewardInfo', Thrift.MessageType.CALL, this.seqid());
  var params = {
    req: req
  };
  var args = new IRISHubService_GetTotalRewardInfo_args(params);
  args.write(output);
  output.writeMessageEnd();
  return this.output.flush();
};

IRISHubServiceClient.prototype.recv_GetTotalRewardInfo = function(input,mtype,rseqid) {
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException();
  ...
  var result = new IRISHubService_GetTotalRewardInfo_result();
  result.read(input);
  input.readMessageEnd();
  ...
  return callback('GetTotalRewardInfo failed: unknown result');
};
...
IRISHubServiceProcessor.prototype.process_GetTotalRewardInfo = function(seqid, input, output) {
  var args = new IRISHubService_GetTotalRewardInfo_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.GetTotalRewardInfo.length === 1) {
    Q.fcall(this._handler.GetTotalRewardInfo.bind(this._handler), args.req)
      .then(function(result) {
        var result_obj = new IRISHubService_GetTotalRewardInfo_result({success: result});
        output.writeMessageBegin("GetTotalRewardInfo", Thrift.MessageType.REPLY, seqid);
        result_obj.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result;
        if (err instanceof model_ttypes.Exception) {
          result = new IRISHubService_GetTotalRewardInfo_result(err);
          output.writeMessageBegin("GetTotalRewardInfo", Thrift.MessageType.REPLY, seqid);
        } else {
          result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
          output.writeMessageBegin("GetTotalRewardInfo", Thrift.MessageType.EXCEPTION, seqid);
        }
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.GetTotalRewardInfo(args.req, function (err, result) {
      var result_obj;
      if ((err === null || typeof err === 'undefined') || err instanceof model_ttypes.Exception) {
        result_obj = new IRISHubService_GetTotalRewardInfo_result((err !== null || typeof err === 'undefined') ? err : {success: result});
        output.writeMessageBegin("GetTotalRewardInfo", Thrift.MessageType.REPLY, seqid);
      } else {
        result_obj = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("GetTotalRewardInfo", Thrift.MessageType.EXCEPTION, seqid);
